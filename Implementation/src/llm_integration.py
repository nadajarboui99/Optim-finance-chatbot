    ...
    def generate_response(self, user_query: str, retrieved_chunks: List[Dict[str, Any]], intent: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            response = self.client.chat.complete(
                ...
                temperature=0.2,  # Plus bas pour une génération plus rapide et déterministe
                top_p=0.9,       # Nucleus sampling pour la vitesse
                timeout_seconds=30000000000000  # Timeout réduit
            )
